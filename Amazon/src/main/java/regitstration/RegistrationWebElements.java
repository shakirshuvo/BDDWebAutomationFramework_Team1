...
public class RegistrationWebElements {
    ...
    public static final String randomPasswordLength4to5 = faker.internet().password(4,5);
    ...
    public static final String startHereXPathWebElement ="//a[text()='Start here.']";
