...
public class HomeStepDefinitionS extends CommonAPI {
    ...
    static HomeS homePage;

    @BeforeStep
    public static void getInit() {
        homePage = PageFactory.initElements(driver, HomeS.class);
    }
    ...
    public void i_click_on_toggle_menu_and_a_new_page_appears() {
        waitUntilClickAble(By.id(toggleMenuCheckingById));
        homePage.clickOnElementByID(toggleMenuCheckingById);
    }
    ...
    public void i_click_on_espanol_and_a_new_page_appears() {
        homePage.clickOnElement(spanishLanguageByLinkTest);
    }
...
//    @When("I click on ä¸­æ–‡ and a new page appears")
//    public void i_click_on_ä¸­æ–‡_and_a_new_page_appears() {
//        homePage.clickOnElement(chineseLanguageByLinkTest);
//    }
    ...
    public void i_click_on_subscribe_now_and_a_new_page_appears() {
        homePage.clickOnElement(subscribeNowByName);
    }
    ...
    public void iClickOn中文AndANewPageAppears() {
