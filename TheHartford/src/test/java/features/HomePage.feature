Feature: The Hartford Home Page Functionality Check
  ...
  @SmokeTest
  Scenario: Check Home Web element is functional
    When I Click on Home Web Element
    Then I Verify Home page title

  @SmokeTest
  Scenario: Check Business Web element is functional
  ...
  @SmokeTest
  Scenario: Check Home Insurance Web element is functional
