...
import static marriottHomeByMobin.MarriottHomePageWebElementsByMobin.*;

public class MarriottHomePageByMobin extends CommonAPI {
...
//        languageCrossBox.click();
    ...
    public void validateDeutsch(){
        ...
        String expectedResult = "https://www.marriott.de/default.mi";
...
//        languageCrossBox.click();
    ...
    public void validateEspanol(){
        String actualResult = getCurrentPageUrl();
        String expectedResult = "https://www.espanol.marriott.com/default.mi";
        Assert.assertEquals(actualResult,expectedResult,"Test failed");
    }
    //*********************************************
