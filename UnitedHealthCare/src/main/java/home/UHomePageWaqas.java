...
import static home.UHomePageWebElementsWaqas.*;


public class UHomePageWaqas extends CommonAPI {
    ...
    public void validateClickGroupRetiree(){
        String actual = driver.getCurrentUrl();
        String expected = "https://www.uhc.com/employer/group-retiree-solution";
        Assert.assertEquals(actual, expected, "Test failed");
    }
}
