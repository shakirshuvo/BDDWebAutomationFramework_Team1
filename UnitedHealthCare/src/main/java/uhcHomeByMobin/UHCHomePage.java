...
import static uhcHomeByMobin.UHCHomePageWebElements.*;
...
//    }
    ...
    public void clickRegisterNowButton   () {
        handleNewTab(driver);
        myuhcRegisterNow.click();
    }

    public void selectBirthMonth   () {
        myuhcMonthDropDown.click();
        myuhcRegisterBirthMonth.click();
    }

    public void clickSSNRadioButton   () {
        myuhcSSNRadioButton.click();
    }

    public void insertRegistratinInformation   (String firstName, String lastName, String socialSecurityNumber, String zip, String birthDate, String birthYear) throws InterruptedException {
//        scrollUpDownByHeight();
//        clearInputBoxByWebElement(myuhcFirstName);
        myuhcFirstName.sendKeys(firstName);
//        clearInputBoxByWebElement(myuhcLastName);
        myuhcLastName.sendKeys(lastName);
//        clearInputBoxByWebElement(myuhcDateInput);
        myuhcDateInput.sendKeys(birthDate);
//        clearInputBoxByWebElement(myuhcYearInput);
        myuhcYearInput.sendKeys(birthYear);
//        clearInputBoxByWebElement(myuhcSSNInput);
        myuhcSSNInput.click();
        sleepFor(5);
        myuhcSSNInput.sendKeys(socialSecurityNumber);
//        clearInputBoxByWebElement(myuhcZipCodeInput);
        myuhcZipCodeInput.sendKeys(zip);
    }


    public void clickMyuhcRegistrationSubmitButton   () {
        scrollUpDownByHeight();
        myuhcRegistrationContinue.click();
    }

    // Validation Method
    public void validateMyuhcRegistrationError  (){
        String actualResult = myuhcRegistrationError.getText();
        System.out.println(actualResult);
        String expectedResult = "We're having trouble finding you in our records. Please check that your entries match the information on your health insurance ID card.";
        Assert.assertEquals(actualResult,expectedResult,"Test failed");
    }
    //*********************************************
