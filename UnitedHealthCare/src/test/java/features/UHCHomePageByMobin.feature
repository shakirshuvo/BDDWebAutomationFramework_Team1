...
##  17
#  @SmokeTest
#  Scenario: Successful redirecting after clicking AboutUs tab
#    When User clicks on AboutUs tab
#    Then User is directed to AboutUs page
##  18
#  @SmokeTest
#  Scenario: Successful redirecting after clicking Accessibility tab
#    When User clicks on Accessibility tab
#    Then User is directed to Accessibility page
#    #  19
#  @SmokeTest
#  Scenario: Successful redirecting after clicking Legal tab
#    When User clicks on Legal tab
#    Then User is directed to Legal page
#    #  20
#  @SmokeTest
#  Scenario: Successful redirecting after clicking Privacy tab
...
#      22
  ...
  Scenario Outline: Negetiv testing for myuhc registration with invalid information
    ...
    Examples:
      ...
      | Johny     | Deep     | 12-3451               | 11470 | 12        | 1981      |
#      | Jenny     | Parker   | 123452               | 11470 | 13        | 1982      |
#      | Jamboo    | Jackson  | 123453               | 11470 | 14        | 1983      |
#      | Jojo      | Mandes   | 123454               | 11470 | 15        | 1984      |
